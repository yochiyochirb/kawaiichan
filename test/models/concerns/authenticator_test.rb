...
class AuthenticatorTest < ActiveSupport::TestCase
  ...
  test 'team_member? should return true if team member' do
    @pseudo_class.stub(:fetch_team_member_uids, %w(U11111111 U22222222)) do
  ...
  test 'fetch_team_member_uids should return uid array fetched from Slack' do
    VCR.use_cassette 'slack/users_info' do
      assert_equal %w(U42424242 U66666666), @pseudo_class.fetch_team_member_uids
    end
  end
end
