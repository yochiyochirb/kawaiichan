...
class EmojiHelperTest < ActionView::TestCase
  test "should convert emoji alias" do
    expected = 'Hello <img alt="new_moon_with_face" src="/images/emoji/unicode/1f31a.png" ' \
               'style="vertical-align:middle" width="20" height="20" />, good-bye ' \
               '<img alt="sun_with_face" src="/images/emoji/unicode/1f31e.png" ' \
